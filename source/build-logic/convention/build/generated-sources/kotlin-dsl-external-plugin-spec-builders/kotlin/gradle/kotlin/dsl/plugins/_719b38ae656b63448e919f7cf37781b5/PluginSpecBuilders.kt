...
package gradle.kotlin.dsl.plugins._719b38ae656b63448e919f7cf37781b5
...
/**
 * The `org.docstr` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgDocstrPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.docstr`.
 */
internal
val `OrgPluginGroup`.`docstr`: `OrgDocstrPluginGroup`
    get() = `OrgDocstrPluginGroup`(plugins)


/**
 * The `org.docstr.gwt` plugin implemented by [org.docstr.gwt.GwtPlugin].
 */
internal
val `OrgDocstrPluginGroup`.`gwt`: PluginDependencySpec
    get() = plugins.id("org.docstr.gwt")
...
/**
 * The `org.javacc` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgJavaccPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.javacc`.
 */
internal
val `OrgPluginGroup`.`javacc`: `OrgJavaccPluginGroup`
    get() = `OrgJavaccPluginGroup`(plugins)


/**
 * The `org.javacc.javacc` plugin implemented by [org.javacc.plugin.gradle.javacc.JavaccPlugin].
 */
internal
val `OrgJavaccPluginGroup`.`javacc`: PluginDependencySpec
    get() = plugins.id("org.javacc.javacc")
